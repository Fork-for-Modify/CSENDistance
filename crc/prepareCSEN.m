function [] = prepareCSEN(save_subdir, Dic, param)    
	...
	save_path = ['data/CSENdata-', param.DicDesign, '/', save_subdir];
    if ~exist(save_path, 'dir')
       mkdir(save_path)
    end    
    save(strcat(save_path, '/', param.modelName, '_mr_', num2str(param.MR), ...
