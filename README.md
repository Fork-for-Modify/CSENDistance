...
Content:
- [Representation Based Regression for Object Distance Estimation](#representation-based-regression-for-object-distance-estimation)
  - [Citation](#citation)
...
After unzipping, move them under ```data/kitti-data/``` folder and using ```generate-csv.py``` script generate a csv file for the KITTI annotations:
